    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="stock.php" style="color: #028a0f;">Gérer les stocks</a>
                </li>

                <li class="nav-item">
                    <a class="nav-link" href="admin_clients.php" style="color: #028a0f;">Gérer les utilisateurs</a>
                </li>
